...
const Share: React.FC<ShareProps> = () => {
    ...
    return (
        <div className='card floating share__promt_card' id='share'>
            ...
            <div className='card-content'>
                <p>Share Duration</p>
                <div className='imput-group input'>
                    <input type='number'
                        max={214748364}
                        min={1}
                        ...
                        value={time}></input>
                    <select className='right' value={unit} onChange={handleUnitChange} aria-label='timeUnit'>
